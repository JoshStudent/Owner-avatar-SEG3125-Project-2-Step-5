    ...
    return (
        <>
            ...
            <div className="featured">
                ...
                <img className="featured-img" src={require('./assets/img4.png')} alt="Flower VS It." width="800" height="600" />
            ...
            <div className="featured">
                ...
                <img className="featured-img" src={require('./assets/img2.jpg')} alt="Blue Person." width="340" height="370" />
                <div>
